"""R2 (S3-compatible) storage for rendered engagement-template PDFs — own namespace, own lazy client.

Rendered PDFs land under ``engagement-templates/`` in the configured bucket (never the data-lake
