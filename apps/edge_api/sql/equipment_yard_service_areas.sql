...
CREATE TABLE IF NOT EXISTS gtm.equipment_yard_service_areas (
...
CREATE INDEX IF NOT EXISTS equipment_yard_service_areas_uei_idx
    ON gtm.equipment_yard_service_areas (uei);
