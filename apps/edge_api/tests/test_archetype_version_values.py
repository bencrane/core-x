"""Unit tests for the archetype-version baked-value path (government-contracted prepaid-introductions).
...
from apps.edge_api.src.archetype_versions import catalog, render, values
