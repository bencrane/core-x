...
**Companion:** [docs/analysis/overture_places_structural_diagnostic.md](overture_places_structural_diagnostic.md) — the read-only diagnostic this directive remediates. Read it first; every decision below traces to a measured finding there.
