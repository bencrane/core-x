...
| `rollup_epa_air` | 1 row / `REGISTRY_ID` | `registry_id` | **BTREE** `registry_id`; **BITMAP** `caa_hpv_flag`, `has_air_violation` | `epa_icis_air_violations`, `_formal_actions`, `_informal_actions`, `_stack_tests`, `_title_v_certs`, `_fces_pces`, `_pollutants` |
