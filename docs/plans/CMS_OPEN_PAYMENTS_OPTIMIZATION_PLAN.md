...
**Built on:** `docs/cms_open_payments_structural_diagnostic.md` (current live state, 2026-06-06).
...
- Diagnostic (current state): `docs/cms_open_payments_structural_diagnostic.md`
...
- `LANCE_MEM_POOL_SIZE` precedent (spill path): `pipelines/ingest_epa/materialize_epa_history.py`; `docs/pdl_companies_structural_diagnostic.md` §4.2
