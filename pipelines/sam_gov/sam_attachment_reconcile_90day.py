...
Durability backstop for sam_attachment_download_90day.py. Proves (and with --backfill,
...
Report (read-only):
    doppler run --project core-x --config prd -- \
      ...
      python pipelines/sam_gov/sam_attachment_reconcile_90day.py
...
live writer; Lance append is not concurrent-safe):
    ... python pipelines/sam_gov/sam_attachment_reconcile_90day.py --backfill
"""
