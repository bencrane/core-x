...
-- Written by pipelines/sam_gov/sam_attachment_gtm_scope.py:_record_run via psycopg
...
-- award (sam_opps_attachment_manifest_winners.contract_award_unique_key / award_keys) and scoring
...
-- consumed by sam_attachment_extract.py Phase 1 as a terminal `skipped_out_of_scope` gate.
--
...
CREATE INDEX IF NOT EXISTS sam_attachment_gtm_scope_runs_run_id_idx
    ON ops.sam_attachment_gtm_scope_runs (run_id);
CREATE INDEX IF NOT EXISTS sam_attachment_gtm_scope_runs_started_at_idx
